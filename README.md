...
- Git-flow 전략을 기반으로 main, develop 브랜치와 각 기능의 보조 브랜치를 운용했습니다.
- main, develop, 각 기능 브랜치로 나누어 개발을 하였습니다.
    - **main** 브랜치는 배포 단계에서만 사용하는 브랜치입니다. 최종으로 개발이 완료된 Branch에서 Pull하였습니다.
    - **develop** 브랜치는 개발 단계에서 git-flow의 master 역할을 하는 브랜치입니다.
    - **각 기능** 브랜치는 기능 단위로 독립적인 개발 환경을 위하여 사용하였습니다. 개발을 한 후 dev를 통해 기능을 merge하는 과정을 가졌습니다.
